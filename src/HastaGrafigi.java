    ...
    public HastaGrafigi(ArrayList<Integer> scores, ArrayList<java.sql.Date> scoreDates, int i, int width, int height, ArrayList<String> scoreTimes) {
        ...
        switch (graphKind) {
            case 0:
                ...
                maxNormalValue = 100;
                graphMax = 160;
                graphHeader = "Nabız Grafiği (bpm)";
                break;
            case 1:
                minNormalValue = 90;
                maxNormalValue = 120;
                graphMax = 200;
                graphHeader = "Sistolik Tansiyon Grafiği (mmHg)";
                break;
            case 2:
                minNormalValue = 60;
                maxNormalValue = 80;
                graphMax = 140;
                graphHeader = "Diastolik Tansiyon Grafiği (mmHg)";
                break;
            case 3:
                minNormalValue = 36;
                maxNormalValue = 38;
                graphMax = 50;
                graphHeader = "Vücut Sıcaklığı Grafiği (°C)";
                break;
            case 4:
                minNormalValue = 12;
                maxNormalValue = 20;
                graphMax = 50;
                graphHeader = "Solunum Grafiği (br/min)";
                break;
            case 5:
                minNormalValue = 70;
                maxNormalValue = 100;
                graphMax = 500;
                graphHeader = "Kan Şekeri Grafiği (mg/dL)";
                break;
            case 6:
                minNormalValue = 90;
                maxNormalValue = 100;
                graphMax = 100;
                graphHeader = "Oksijen Satürasyonu Grafiği (%)";
                break;
        }
    }
